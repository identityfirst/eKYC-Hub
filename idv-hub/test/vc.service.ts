...
describe('Verification matching test', () => {
    ...
    it('should correctly translate driving license [array mix]', () =>{
        runMathingTest('./vcs/drivinglicense.json','./inputs/request_mix_array_ok.json', './expected/response_mix_array_ok.json')
    });
